...
OUT_DIR = PROJECT_ROOT / "outputs" / f"cv_splits_{SCENARIO}"
...
n_splits = 5
val_frac_of_trainval = 0.125  # 70/10/20 proportions
...
for i in range(1, n_splits + 1):
    ...
    # Run model 
    net = CDR_model()               
    metrics = net.train(train_drug=train, test_drug=test, val_drug=val)
